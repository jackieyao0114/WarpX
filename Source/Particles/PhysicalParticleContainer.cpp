            ...
            if (gamma_boost == 1.) {
                ...
                if (t > 0) {
                   ...
                   if (std::abs(rho_GJ) < 1E-35) {
                      ...
                      //if (sigma_inj < 0) {
                      //amrex::Print() << " rho is " << rho_arr(ii,jj,kk) << " rho_GJ " << rho_GJ << " rel err : " << rel_rho_err << " z " << cc_z << " sigma_inj " << sigma_inj<< "\n";
                      //}
                      if ( rel_rho_err > 0.05) {
                      //   amrex::Print() << "stopping injection\n";
                         p.id() = -1;
                         return;
                      }
                   }
