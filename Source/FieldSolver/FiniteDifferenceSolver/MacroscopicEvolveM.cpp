        ...
        for (MFIter mfi(*Mfield[0], TilingIfNotGPU()); mfi.isValid(); ++mfi) /* remember to FIX */
        {
          ...
          Array4<Real> const& mag_gamma_arr = mag_gamma_mf.array(mfi);
            ...
            [=] AMREX_GPU_DEVICE (int i, int j, int k){
              ...
              Mx(i, j, k, 0) += dt * (-PhysConst::mu0 * mag_gamma_interp) * ( Mx(i, j, k, 1) * Hz_xtemp - Mx(i, j, k, 2) * Hy_xtemp)
              ...
              Mx(i, j, k, 1) += dt * (-PhysConst::mu0 * mag_gamma_interp) * ( Mx(i, j, k, 2) * Hx(i, j, k) - Mx(i, j, k, 0) * Hz_xtemp)
              ...
              Mx(i, j, k, 2) += dt * (-PhysConst::mu0 * mag_gamma_interp) * ( Mx(i, j, k, 0) * Hy_xtemp - Mx(i, j, k, 1) * Hx(i, j, k))
            ...
            [=] AMREX_GPU_DEVICE (int i, int j, int k){
              ...
              My(i, j, k, 0) += dt * (-PhysConst::mu0 * mag_gamma_interp) * ( My(i, j, k, 1) * Hz_ytemp - My(i, j, k, 2) * Hy(i, j, k))
              ...
              My(i, j, k, 1) += dt * (-PhysConst::mu0 * mag_gamma_interp) * ( My(i, j, k, 2) * Hx_ytemp - My(i, j, k, 0) * Hz_ytemp)
              ...
              My(i, j, k, 2) += dt * (-PhysConst::mu0 * mag_gamma_interp) * ( My(i, j, k, 0) * Hy(i, j, k) - My(i, j, k, 1) * Hx_ytemp)
            ...
            [=] AMREX_GPU_DEVICE (int i, int j, int k){
              ...
              Mz(i, j, k, 0) += dt * (-PhysConst::mu0 * mag_gamma_interp) * ( Mz(i, j, k, 1) * Hz(i, j, k) - Mz(i, j, k, 2) * Hy_ztemp)
              ...
              Mz(i, j, k, 1) += dt * (-PhysConst::mu0 * mag_gamma_interp) * ( Mz(i, j, k, 2) * Hx_ztemp - Mz(i, j, k, 0) * Hz(i, j, k))
              ...
              Mz(i, j, k, 2) += dt * (-PhysConst::mu0 * mag_gamma_interp) * ( Mz(i, j, k, 0) * Hy_ztemp - Mz(i, j, k, 1) * Hx_ztemp)
