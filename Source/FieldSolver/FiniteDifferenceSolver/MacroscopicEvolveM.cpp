...
void FiniteDifferenceSolver::MacroscopicEvolveM (
	...
	amrex::Print() << "In the MacroscopicEvolveMCartesian " <<std::endl;
        ...
        for (MFIter mfi(*Mfield[0], TilingIfNotGPU()); mfi.isValid(); ++mfi) /* remember to FIX */
        {
	      ...
	      amrex::Print() << "B " << " i " << i << " j " << j << " k " << k <<  std::endl;
	      ...
	      amrex::Print() << " mv1 " <<MacroscopicProperties::macro_avg_to_face(i,j,k,amrex::IntVect(1,0,0),mag_alpha_arr) << std::endl;
	      amrex::Print() << " mv2 " <<MacroscopicProperties::macro_avg_to_face(i,j,k,amrex::IntVect(1,0,0),mag_Ms_arr) << std::endl;
	      amrex::Print() << "B " << " M_xface(i,j,k,0) " << M_xface(i,j,k,0) << std::endl;
	      amrex::Print() << "B " << " M_xface(i,j,k,1) " << M_xface(i,j,k,1) << std::endl;
	      amrex::Print() << "B " << " M_xface(i,j,k,2) " << M_xface(i,j,k,2) << std::endl;
	      }
	      ...
	      if(i==0 && j==1 && k==1) {
	      amrex::Print() << "A " << " i " << i << " j " << j << " k " << k <<  std::endl;
	      amrex::Print() << "A " << " M_xface(i,j,k,0) " << M_xface(i,j,k,0) << std::endl;
	      amrex::Print() << "A " << " M_xface(i,j,k,1) " << M_xface(i,j,k,1) << std::endl;
	      amrex::Print() << "A " << " M_xface(i,j,k,2) " << M_xface(i,j,k,2) << std::endl;
	      }
	      if(i==64 && j==1 && k==1) {
	      amrex::Print() << "A " << " i " << i << " j " << j << " k " << k <<  std::endl;
	      amrex::Print() << "A " << " M_xface(i,j,k,0) " << M_xface(i,j,k,0) << std::endl;
...
//	      amrex::Print() << " Hx_yface " << Hx_yface << std::endl;
//	      amrex::Print() << " Hy_yface " << Hy_yface << std::endl;
//	      amrex::Print() << " Hz_yface " << Hz_yface << std::endl;
//	      amrex::Print() << " Hx_bias_yface " << Hx_bias_yface << std::endl;
//	      amrex::Print() << " Hy_bias_yface " << Hy_bias_yface << std::endl;
//	      amrex::Print() << " Hz_bias_yface " << Hz_bias_yface << std::endl;
//	      amrex::Print() << " mag_gamma_interp " << mag_gamma_interp << std::endl;
//	      amrex::Print() << " PhysConst::mu0 " << PhysConst::mu0 << std::endl;
//	      amrex::Print() << " mv1 " <<MacroscopicProperties::macro_avg_to_face(i,j,k,amrex::IntVect(0,1,0),mag_alpha_arr) << std::endl;
//	      amrex::Print() << " mv2 " <<MacroscopicProperties::macro_avg_to_face(i,j,k,amrex::IntVect(0,1,0),mag_Ms_arr) << std::endl;
//              }

              // x component on y-faces of grid, jordan_first_bug
...
//	      amrex::Print() << " M_yface(i,j,k,0) " << M_yface(i,j,k,0) << std::endl;
//	      amrex::Print() << " M_yface(i,j,k,1) " << M_yface(i,j,k,1) << std::endl;
//	      amrex::Print() << " M_yface(i,j,k,2) " << M_yface(i,j,k,2) << std::endl;
//	      }
//	      if(i==1 && j==64 && k==1) {
//	      amrex::Print() << " i " << i << " j " << j << " k " << k <<  std::endl;
//	      amrex::Print() << " M_yface(i,j,k,0) " << M_yface(i,j,k,0) << std::endl;
...
//	      amrex::Print() << " mag_gamma_interp " << mag_gamma_interp << std::endl;
//	      amrex::Print() << " PhysConst::mu0 " << PhysConst::mu0 << std::endl;
//	      amrex::Print() << " mv1 " <<MacroscopicProperties::macro_avg_to_face(i,j,k,amrex::IntVect(0,0,1),mag_alpha_arr) << std::endl;
//	      amrex::Print() << " mv2 " <<MacroscopicProperties::macro_avg_to_face(i,j,k,amrex::IntVect(0,0,1),mag_Ms_arr) << std::endl;
//              }
...
//	      amrex::Print() << " M_zface(i,j,k,1) " << M_zface(i,j,k,1) << std::endl;
