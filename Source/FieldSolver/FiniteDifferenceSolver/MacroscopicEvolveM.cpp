        ...
        amrex::ParallelFor(tbx, tby, tbz,
            [=] AMREX_GPU_DEVICE(int i, int j, int k) {
                ...
                if (mag_Ms_arrx(i, j, k) != 0 && mag_alpha_arrx(i, j, k) != 0 && mag_gamma_arrx(i, j, k) != 0)
                {
                    ...
                    Real M_magnitude = (M_normalization == 0) ? std::sqrt(std::pow(M_xface(i, j, k, 0), 2.0) + std::pow(M_xface(i, j, k, 1), 2.0) + std::pow(M_xface(i, j, k, 2), 2.0)) : mag_Ms_arrx(i, j, k);
                    ...
                    M_xface(i, j, k, 0) += dt * (PhysConst::mu0 * mag_gamma) * (M_xface_prev(i, j, k, 1) * Hz_eff - M_xface_prev(i, j, k, 2) * Hy_eff) + dt * Gil_damp * (M_xface_prev(i, j, k, 1) * (M_xface_prev(i, j, k, 0) * Hy_eff - M_xface_prev(i, j, k, 1) * Hx_eff) - M_xface_prev(i, j, k, 2) * (M_xface_prev(i, j, k, 2) * Hx_eff - M_xface_prev(i, j, k, 0) * Hz_eff));

                    // y component on x-faces of grid
                    M_xface(i, j, k, 1) += dt * (PhysConst::mu0 * mag_gamma) * (M_xface_prev(i, j, k, 2) * Hx_eff - M_xface_prev(i, j, k, 0) * Hz_eff) + dt * Gil_damp * (M_xface_prev(i, j, k, 2) * (M_xface_prev(i, j, k, 1) * Hz_eff - M_xface_prev(i, j, k, 2) * Hy_eff) - M_xface_prev(i, j, k, 0) * (M_xface_prev(i, j, k, 0) * Hy_eff - M_xface_prev(i, j, k, 1) * Hx_eff));

                    // z component on x-faces of grid
                    M_xface(i, j, k, 2) += dt * (PhysConst::mu0 * mag_gamma) * (M_xface_prev(i, j, k, 0) * Hy_eff - M_xface_prev(i, j, k, 1) * Hx_eff) + dt * Gil_damp * (M_xface_prev(i, j, k, 0) * (M_xface_prev(i, j, k, 2) * Hx_eff - M_xface_prev(i, j, k, 0) * Hz_eff) - M_xface_prev(i, j, k, 1) * (M_xface_prev(i, j, k, 1) * Hz_eff - M_xface_prev(i, j, k, 2) * Hy_eff));
            ...
            [=] AMREX_GPU_DEVICE(int i, int j, int k) {
                ...
                if (mag_Ms_arry(i, j, k) != 0 && mag_alpha_arry(i, j, k) != 0 && mag_gamma_arry(i, j, k) != 0)
                {
                    ...
                    Real M_magnitude = (M_normalization == 0) ? std::sqrt(std::pow(M_yface(i, j, k, 0), 2.0) + std::pow(M_yface(i, j, k, 1), 2.0) + std::pow(M_yface(i, j, k, 2), 2.0)) : mag_Ms_arry(i, j, k);
            ...
            [=] AMREX_GPU_DEVICE(int i, int j, int k) {
                ...
                if (mag_Ms_arrz(i, j, k) != 0 && mag_alpha_arrz(i, j, k) != 0 && mag_gamma_arrz(i, j, k) != 0)
                {
                    ...
                    Real M_magnitude = (M_normalization == 0) ? std::sqrt(std::pow(M_zface(i, j, k, 0), 2.0_rt) + std::pow(M_zface(i, j, k, 1), 2.0_rt) + std::pow(M_zface(i, j, k, 2), 2.0_rt)) : mag_Ms_arrz(i, j, k);
